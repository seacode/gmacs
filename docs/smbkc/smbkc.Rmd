...
author: "Darcy Webber, Jie Zheng, James Ianelli"
date: "May 2016"
output:
  pdf_document:
    highlight: zenburn
...
In May 2015, eight model scenarios were considered followed by 20 scenarios examined in September 2015.
In this presentation results from the selected model in September was used for contrast with the current
implementation.
...
```{r bts_resid, fig.cap = " Standardized residuals for total trawl survey biomass for Gmacs configuration. \\label{fig:bts_resid}"}
plot_cpue(M, "ADFG Pot", ylab = "Pot survey CPUE (crab/potlift)")
```
