...
\begin{tabular}{lccccccc}
  ...
  2015/16 & `r round(M[[3]]$spr_bspr/1000 * 0.5, 2)`$^D$ & `r round(M[[3]]$ssb[length(M[[3]]$ssb)-1]/1000, 2)`$^D$ & 0.19 & 0.05 & 0.05 & 0.28 & 0.22 \\
...
\begin{tabular}{lccccccc}
  ...
  2015/16 & `r sprintf("%.1f", round(M[[3]]$spr_bspr * 2204.62/1e6 * 0.5, 1))`$^D$ & `r round(M[[3]]$ssb[length(M[[3]]$ssb)-1] * 2204.62/1e6, 2)`$^D$ & 0.41 & 0.105 & 0.105 & 0.62 & 0.49 \\
  2016/17 & & `r round(M[[3]]$ssb[length(M[[3]]$ssb)] * 2204.62/1e6, 2)`$^D$ & & & & `r round(M[[3]]$spr_cofl * 2204.62/1e6, 2)` & `r round(M[[3]]$spr_cofl * 2204.62/1e6*0.8, 2)` \\
  \hline
\end{tabular}
\end{table}
