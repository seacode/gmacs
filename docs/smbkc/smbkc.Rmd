...
df <- data.frame(M[[2]]$mod_yrs, M[[2]]$mean_wt)
names(df) <- c("Year","Stage-1","Stage-2","Stage-3")
tab <- xtable(df, caption = "Relationship between carapace width (mm) and weight (kg) in all of the models (provided as a vector of weights at length to Gmacs).", label = "tab:length-weight", digits = 3)
