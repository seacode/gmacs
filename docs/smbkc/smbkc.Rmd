...
\begin{table}[ht]
\centering
\caption{Status and catch specifications (1000 tonnes) (scenario {\bf Gmacs base}). Notes: A - calculated from the assessment reviewd by the Crab Plan Team in September 2013, B - calculated from the assessment reviewd by the Crab Plan Team in September 2014, C - calculated from the assessment reviewd by the Crab Plan Team in September 2015, D - calculated from the assessment reviewd by the Crab Plan Team in September 2016} 
\label{tab:status}
\begin{tabular}{lccccccc}
  ...
  2015/16 & 1.84$^D$ & `r round(M[[3]]$ssb[length(M[[3]]$ssb)-1]/1000, 2)`$^D$ & 0.41 & 0.05 & 0.05 & 0.28 & 0.22 \\
  2016/17 &          & `r round(M[[3]]$ssb[length(M[[3]]$ssb)]/1000, 2)`$^D$ &      &      &      & `r round(M[[3]]$spr_cofl/1000, 2)` & `r round(M[[3]]$spr_cofl/1000*0.8, 2)` \\
  \hline
\end{tabular}
\end{table}
...
\begin{tabular}{lcccccccc}
  ...
  2016/17 & 4b & `r round(M[[3]]$spr_bspr/1000, 2)` & `r round(M[[3]]$ssb[length(M[[3]]$ssb)]/1000, 2)` & `r round(M[[3]]$ssb[length(M[[3]]$ssb)]/M[[3]]$spr_bspr, 2)` & 0.09 & 1 & 1978-2016 & 0.18 \\ 
  \hline
\end{tabular}
\end{table}
...
\begin{tabular}{lccl}
  ...
  handling mortality & & & \\
  Fishing mortality & $\sigma_\text{df}$ & 50 & \\
  Fishing mortality & $\sigma_\text{tb}$ & 50 & \\
  Fishing mortality & $\sigma_\text{fb}$ & 50 & \\
  \hline
\end{tabular}
\end{table}
...
\begin{tabular}{lrrrlr}
  ...
  Average directed fishery fishing mortality $\bar{F}^\text{df}$                 & -  & 0.3 & - & - & 1 \\
  $\bar{F}^\text{tb}$                 & -  & 0.001 & - & - & 1 \\
  $\bar{F}^\text{fb}$                 & -  & 0.001 & - & - & 1 \\
  \hline
\end{tabular}
\end{table}
