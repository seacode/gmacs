...
\begin{table}[ht]
\centering
\caption{Groundfish SMBKC male bycatch biomass (tonnes) estimates. Trawl includes pelagic trawl and non-pelagic trawl types. The total mortality is calculated assuming handling mortalities of 0.8 for trawl and 0.5 for fixed gear. Source: J. Zheng, ADF\&G, and author estimates based on data from R. Foy, NMFS. AKRO estimates used after 2008/09.} 
...
Estimate <- NULL
Model <- NULL
Mname <- c("Gmacs match","Gmacs base","Gmacs Francis","Gmacs M","Gmacs force")
for (ii in 2:6)
{
    x <- M[[ii]]$fit
    i <- c(grep("m_dev", x$names)[1],
