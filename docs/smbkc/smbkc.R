...
2. **Catches**: Peak historical harvest was 9.454 million pounds (4288 tonnes) in 1983/84^[1983/84 refers to a fishing year that extends from 1 July 1983 to 30 June 1984.]. The fishery was closed for 10 years after the stock was declared overfished in 1999. Fishing resumed in 2009/10 with a fishery-reported retained catch of 0.461 million pounds (209 tonnes), less than half the 1.167 million pound (529.3 tonnes) TAC. Following three more years of modest harvests supported by a fishery catch per unit effort (CPUE) of around 10 crab per pot lift, the fishery was again closed in 2013/14 due to declining trawl-survey estimates of abundance and concerns about the health of the stock. The directed fishery resumed again in 2014/15 with a TAC of 0.655 million pounds (300 tonnes), but the fishery performance was relatively poor with a retained catch of 0.309 million pounds (140 tonnes).
