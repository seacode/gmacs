...
# Read in Jie's file
j_mmb  = read.table("jieOutput/jie_mmb.rep",       header = TRUE)
...
### Gmacs-BBRKC
>>>>>>> 800bbc4cfc81673da2751116c694a103f43c770e
...
```{r survey_biomass, fig.cap = "Model fits to survey biomass.\\label{fig:survey_biomass}"}
#plot_cpue(M)
