...
M[[jj]]$fit$std[ii] <- log(j_ssb$mmb_sd)
...
```{r survey_biomass_BSFRF, fig.cap = "Model fits to the BSFRF survey biomass (tonnes) in 2007 and 2008. The error bars represent plus and minus 2 standard deviations.\\label{fig:survey_biomass_BSFRF}"}
plot_cpue(M, "BSFRF", ylab = "Survey biomass (tonnes)")
#plot_cpue(M, ylab = "Survey biomass (tonnes)")
```
