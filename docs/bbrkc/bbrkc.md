...
```
## Error in plot_size_transition(M, xlab = "Carapace length (mm)", female = TRUE): unused argument (female = TRUE)
```
...
\begin{tabular}{lrr}
 ...
 & OneSex & TwoSex \\ 
  \hline
Abundance1 & 1504.48 & 354.71 \\ 
  Abundance2 & -2.92 & -0.81 \\ 
  Catch1 & 1087.44 & 303.09 \\ 
  Catch2 & 102.23 & 174.28 \\ 
  Catch3 & -76.76 & -51.80 \\ 
  Catch4 &  & -80.85 \\ 
  Growth increment1 & 0.00 & 0.00 \\ 
  Recruitment deviations1 & 111.48 & 492.00 \\ 
  Size composition1 & 675.90 & 785.54 \\ 
  Size composition2 & 1207.13 & 2927.37 \\ 
  Size composition3 & 1306.55 & 2073.65 \\ 
  Size composition4 & 4138.38 & 32496.71 \\ 
  Size composition5 & 3078.93 & 82.22 \\ 
  Size composition6 & 66.47 &  \\ 
   \hline
\end{tabular}
\end{table}
