...
the gmacs platform.  Since the BBRKC model from @zheng_bristol_2014 treats
...
![Model fits to survey biomass.\label{fig:survey_biomass}](figure/survey_biomass-1.png) 
...
![Mature male biomass.\label{fig:ssb}](figure/spawning_stock_biomass-1.png) 
