...
\begin{table}
  ...
  \hline
      \textcolor{red}{$\delta_i$} & $1$ & Annual natrual mortality rate deviates \\
      \textcolor{red}{$\boldsymbol\nu$} & $\ell \times 1$ & Initial recuitment deviates \\
      \textcolor{red}{$xi_{i,k}$} & $1$ &  Discard mortality rate for each gear
      $k$ in year $i$\\
  \hline
  \end{tabular}
\end{table}
...
\begin{table}
  ...
  \hline
      ...
      $\textcolor{red}{\delta_i}$ & Natural mortality deviate \\
...
\begin{equation*}
  ...
  \begin{cases}
    ...
    M_{h,i} e^{\textcolor{red}{\delta_i}} \quad \text{for} \quad i>1
  \end{cases},
\end{equation*}
where
\begin{equation*}
  \textcolor{red}{\delta_i} \sim \mathcal{N} \left( 0, \sigma^2_M \right).
\end{equation*}
...
\begin{table}
  ...
  \hline
      ...
      \textcolor{red}{$\xi_{i,k}$} & $1$ & Discard mortality rate for gear $k$
      in year $i$ \\
...
\begin{equation*}
  \boldsymbol\nu_{h,i,k} = \boldsymbol{s}_{h,i,k} \left[ \boldsymbol{y}_{h,i,k} + (1 - \boldsymbol{y}_{h,i,k})
    \textcolor{red}{\xi_{i,k}} \right],
\end{equation*}
where $\textcolor{red}{\xi_{i,k}}$ is the discard mortality rate for fishery $k$ in
year $i$.
\end{frame}
...
\begin{align*}
  ...
  p[x_\ell-0.5 \Delta x \le x \le x_\ell+0.5 \Delta x] &= p[x] = \int^{x_\ell+0.5
    \Delta x}_{x_\ell-0.5 \Delta x} \frac{x^{\alpha-1} \exp
