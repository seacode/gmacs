    ...
    \begin{columns}[t]
      ...
      \begin{column}{.3\linewidth}
        ...
        \begin{block}{\large General Size-structured Equilibrium Model}
          ...
          It is also possible to accommodate the dynamics of molting probabilities, and 
          jointly modeling the abundance of new and old shell crab and maturity state.
        \end{block}
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        \vskip1ex
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      ...
      \begin{column}{.3\linewidth}
        ...
        \begin{block}{\large Reference Points (SPR-based)}
          ...
          GMACS uses an iterative solution based on solving equations \eqref{T1.14} 
          ...
          \begin{itemize}
            ...
            \item Catch only method requires prior information on one of the following:
              \begin{itemize}
                 ...
                 \item or an estimate of current depletion level,
