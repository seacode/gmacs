...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{table}
      ...
      &\nu_{h,k,l}  = s_{h,k,l} [y_{h,k,l} + (1-y_{h,k,l})\xi_{h,k}]\label{T4.5}\\
      %%
      %%
      ...
      \normalEq
    \end{table}
    In cases where only one sex is allowed to be retained (i.e., male only fisheries) the retention probability $y_{h,k,l} = 0$ for all size-classes.  In this case, it is not necessary to estimate parameters for the retention curve, as all females for example, would be discarded.
