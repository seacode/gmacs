...
## ———————————————————————————————————————————————————————————————————————————————————— ##    
## Period 1
  144.170986  100.    170.0         3       0    0.0    999.0         # molt_mu males
  180.0       50.     200.0        -4       0    0.0    999.0         # molt_mu females (molt every year)
    0.05      0.01    1.0           4       0    0.0    999.0         # molt_cv males
    0.1       0.01    9.0          -4       0    0.0    999.0         # molt_cv females (molt every year)
## Period 2
  140.5       100.    170.0         3       0    0.0    999.0         # molt_mu males
  190.0       50.     200.0        -4       0    0.0    999.0         # molt_mu females (molt every year)
...
# Gear-6
   ...
   6     24    2   2    130    1    180    0       1    999    4     1975   2016
## ———————————————————————————————————————————————————————————————————————————————————— ##
## Retained                                                                             ##
## gear  par   sel                                                   start  end         ##
## index index par sex  ival  lb    ub     prior   p1   p2     phz   period period      ##
