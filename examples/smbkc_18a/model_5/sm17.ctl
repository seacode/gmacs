...
## ival    lb       ub    phz   prior   p1       p2    Analytic?   Lambda
   0.4     0.2      2.0   -4    0       0        9.0   0           1.5     # NMFS trawl
4.11135867487e-4 0 5       3    0       0        9.0   0           2       # ADF&G pot
## ———————————————————————————————————————————————————————————————————————————————————— ##
...
# 1   1   1   # LAMBDA
#  1.5162   0.3779   0.3856
#  1.7401   0.2575   0.1601
#  1.8656   0.2302   0.1104
#  1.9235   0.2242   0.1005
   1.9483   0.2228   0.0985
## ———————————————————————————————————————————————————————————————————————————————————— ##
