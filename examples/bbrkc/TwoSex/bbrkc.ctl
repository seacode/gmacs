...
## ———————————————————————————————————————————————————————————————————————————————————— ##
 ...
 145.0       1.0     195.0         -3       0    0.0    999.0         # molt_mu
   0.071     0.0001    9.0         -4       0    0.0    999.0         # molt_cv males or combined
   0.071     0.0001    9.0         -4       0    0.0    999.0         # molt_cv
## ——————————————————————————————————————————————————————————————————————————————————— ##
...
## Gear-1    Gear-2    Gear-3   Gear-4
   ...
   1         0         0        0         # sex specific selectivity
...
# Gear-1
   ...
   1     1     1   2    100    5    185    0      10    200    3     1975   2014
   1     2     2   2    120    5    185    0      10    200    3     1975   2014
# Gear-2
   2     3     1   0    110    5    185    0      10    200    3     1975   2014
   2     4     2   0    150    5    185    0      10    200    3     1975   2014
# Gear-3
   3     5     1   0     90   60    150    0       1    200    4     1975   1981
   3     6     2   0    105   70    150    0       1    200    4     1975   1981
   3     7     1   0    100   70    200    0       1    200    3     1982   2014
   3     8     2   0    115   70    200    0       1    200    3     1982   2014
# Gear-4
