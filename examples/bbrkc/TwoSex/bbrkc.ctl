...
# Gear-3
   ...
   3      9    1   2     90   60    200    0       1    999   -3     1975   2016
   3     10    2   2    160   70    200    0       1    999   -3     1975   2016
# Gear-4
...
## ival    lb       ub    phz   prior   p1       p2    Analytic?   LAMBDA
   0.843136  0        2     4    1     0.843136 0.03   0           7       # NMFS, 0.896 is the magic number * 0.941 (Jies max selex)
...
#   0.01     0.5        45.50      1   # Trawl
   0.15     0.5         0.001       1   # Pot
   0.01     0.5         0.001       1   # Trawl
