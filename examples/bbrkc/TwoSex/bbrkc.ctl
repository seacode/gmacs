...
## LEGEND                                                                               ##
##     Type: 0 = uniform, 1 = normal (log-space), 2 = time-varying (NIY)                ##
## ———————————————————————————————————————————————————————————————————————————————————— ##
## Ttpe   Mean_q     SD_q   CPUE_Lambda
   1      0.843136   0.03   1   # NMFS, 0.896 is the magic number * 0.941 (Jies max selex)
   1      1.0        0.03   1   # BSFRF
## ———————————————————————————————————————————————————————————————————————————————————— ##
