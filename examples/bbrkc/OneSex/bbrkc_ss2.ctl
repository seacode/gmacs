...
# —————————————————————————————————————————————————————————————————————————————————————— #
  0.18      0.01         1         -4       2   0.18    0.02         # M
   2.2       -10        20          2       1   -1.2     0.1         # logR0
  12.0       -10        20          2       1    3.0     5.0         # logR1      
...
# —————————————————————————————————————————————————————————————————————————————————————— #
  ...
  140.0     65.0     165.0         -4       0    0.0   999.0         # molt_mu males or combined
...
# Gear-2
  -2     15    1   0    595    1    700    0      1    900   -2     1975   2014
  -2     16    2   0     10    1    700    0      1    900   -2     1975   2014
# Gear-3
  -3     17    1   0    590    1    700    0      1    900   -3     1975   1981
  -3     18    2   0     10    1    700    0      1    900   -3     1982   2014
# Gear-4
  -4     19    1   0    580    1    700    0      1    900   -4     1975   2014
  -4     20    2   0     20    1    700    0      1    900   -4     1975   2014
## ———————————————————————————————————————————————————————————————————————————————————— ##
