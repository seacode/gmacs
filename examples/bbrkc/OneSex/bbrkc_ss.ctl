...
# —————————————————————————————————————————————————————————————————————————————————————— #
 ...
 -0.51       -10      0.75         -4       0    -10    0.75         # ln(sigma_R)
  0.95      0.20      1.00         -4       3    3.0    2.00         # steepness
## ———————————————————————————————————————————————————————————————————————————————————— ##
...
# —————————————————————————————————————————————————————————————————————————————————————— #
  ...
  0.35       0.0      30.0         -3       0    0.0     3.0         # gscale males or combined
...
## ———————————————————————————————————————————————————————————————————————————————————— ##
 ...
 1.e-3   1.e-3   1.e-3   1.e-3   1.e-3   1.e-3 #  0   0   0   # Auto tail compression (pmin)
