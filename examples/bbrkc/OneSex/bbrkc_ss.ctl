...
## index index par sex  init  prior p1   p2     mirror period period                    ##
## ———————————————————————————————————————————————————————————————————————————————————— ##
## Selectivity P(capture of all sizes)
# Gear-1
   1     1     1   0    100   1    100      1   -3     1975   2014
   1     2     2   0    120   1    120      1   -3     1975   2014
# Gear-2
   2     3     1   0    110   1    110     15    3     1975   2014
   2     4     2   0    150   1    150      7    3     1975   2014
# Gear-3
...
## Retained
# Gear-1
  -1     11    1   0    133   0     10    200   -3     1975   2014
  -1     12    2   0    137   0     10    200   -3     1975   2014
# Gear-2
