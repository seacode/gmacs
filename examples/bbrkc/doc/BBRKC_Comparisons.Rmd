...
```{r M_t, fig.cap = "Time-varying natural mortality ($M_t$).\\label{fig:M_t}"}
#M over time
par(mfrow=c(1,1))
...
#Survey biomass fits
plot(gmrep$mod_yrs,as.numeric(gmrep$pre_cpue[1,]),typ="b",ylab="survey biomass ",xlab="Year",ylim=c(0,300000))
