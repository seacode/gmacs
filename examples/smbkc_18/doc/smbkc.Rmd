...
\begin{tabular}{lccccccc}
  ...
  2017/18 & `r round(M[[rec_mod]]$spr_bspr/1000 * 0.5, 2)`$^E$ & `r round(M[[rec_mod]]$ssb[length(M[[rec_mod]]$ssb)-1]/1000, 2)`$^E$ & 0.00 & 0.00 & 0.05 & 0.28 & 0.22 \\
...
\begin{tabular}{lccccccc}
  ...
  2017/18 & `r sprintf("%.1f", round(M[[rec_mod]]$spr_bspr * 2204.62/1e6 * 0.5, 1))`$^E$ & `r round(M[[rec_mod]]$ssb[length(M[[rec_mod]]$ssb)-1] * 2204.62/1e6, 2)`$^E$ & 0.41 & 0.000 & 0.000 & 0.62 & 0.49 \\
...
\begin{tabular}{lcccccccc}
  ...
  2018/19 & 4b & `r round(M[[rec_mod]]$spr_bspr/1000, 2)` & `r round(M[[rec_mod]]$ssb[length(M[[rec_mod]]$ssb)]/1000, 2)` & `r round(M[[rec_mod]]$ssb[length(M[[rec_mod]]$ssb)]/M[[rec_mod]]$spr_bspr, 2)` & 0.09 & 1 & 1978-2017 & 0.18 \\ 
  2019/20 & 4b & `r round(M[[rec_mod]]$spr_bspr/1000, 2)` & `r round(M[[rec_mod]]$ssb[length(M[[rec_mod]]$ssb)]/1000, 2)` & `r round(M[[rec_mod]]$ssb[length(M[[rec_mod]]$ssb)]/M[[rec_mod]]$spr_bspr, 2)` & 0.09 & 1 & 1978-2017 & 0.18 \\ 
  \hline
\end{tabular}
\end{table}
...
Estimate <- NULL
Model <- NULL
Mname <- c("2017","BTS","Ref","VAST","FitSurvey","Francis")
for (ii in mod_scen)
{
    x <- M[[ii]]$fit
    i <- c(grep("m_dev", x$names)[1],
