...
Parameter <- c("Natural mortality deviation in 1998/99 ($\\delta^M_{1998})$",
              ...
              "$q_pot$", "$\\log (\\bar{F}^\\text{df})$","$\\log (\\bar{F}^\\text{tb})$","$\\log (\\bar{F}^\\text{fb})$","$F_\\text{OFL}$","OFL")
...
```{r recruitment, fig.cap = "Comparisons of estimated recruitment time series during 1979-2017 in each of the scenarios. The solid horizontal lines in the background represent the estimate of the average recruitment parameter ($\\bar{R}$) in each model scenario.\\label{fig:recruitment}"}
A <- M
for (i in 2:6) {
...
```{r Dynamic_Bzero, fig.cap = "Comparisons of mature male biomass relative to the dynamic $B_0$ value, (15 February, 1978-2017) for 
