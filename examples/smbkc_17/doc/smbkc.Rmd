...
\begin{tabular}{lccccccc}
  ...
  2016/17 & `r round(M[[rec_mod]]$spr_bspr/1000 * 0.5, 2)`$^E$ & `r round(M[[rec_mod]]$ssb[length(M[[rec_mod]]$ssb)-1]/1000, 2)`$^E$ & 0.00 & 0.00 & 0.05 & 0.28 & 0.22 \\
...
\begin{tabular}{lccccccc}
  ...
  2016/17 & `r sprintf("%.1f", round(M[[rec_mod]]$spr_bspr * 2204.62/1e6 * 0.5, 1))`$^E$ & `r round(M[[rec_mod]]$ssb[length(M[[rec_mod]]$ssb)-1] * 2204.62/1e6, 2)`$^E$ & 0.41 & 0.000 & 0.000 & 0.62 & 0.49 \\
