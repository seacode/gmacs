...
author: |
  | Alathea Letaw$^1$, D'Arcy Webber$^2$, Jie Zheng$^3$, and James Ianelli$^4$
  | $^1$NOAA, alathea.letaw@noaa.gov
  | $^2$Quantifish, darcy@quantifish.co.nz
  | $^3$Alaska Department of Fish and Game, jie.zheng@alaska.gov
  | $^4$NOAA, jim.ianelli@noaa.gov
...
# The model specs
mod_names <- c("2016 Model","Gmacs match","Gmacs 2017") #,"Gmacs M","Gmacs Francis","Gmacs force")
...
.MODELDIR = c("../../smbkc_2016/model_1/", "../model_1/","../model_2/","../model_3/")
