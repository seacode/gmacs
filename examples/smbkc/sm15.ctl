...
# ival        lb        ub        phz   prior     p1      p2         # parameter         #
  ...
  9.0       -7         20          2       1    7.0     30.1         # logR0
  8.0       -7         20         -1       1   -10.0     20.0        # logR1
  8.0       -7         20          1       1    7.0     20.0         # logRbar
  95.0      30         310         2       1    72.5    7.25         # Recruitment Expected Value
  0.15       0.1         7         4       0    0.1     7.0          # Recruitment scale (variance component)
...
# Gear-1
   1     1     1   0    0.416198 0.001 0.999  0       0      1    -4     1978   2015
   1     2     2   0    0.657528 0.001 0.999  0       0      1    -4     1978   2015
   1     3     3   0    0.999 0.001 0.999  0       0      1    -4     1978   2015
#   1     1     1   0    0.5   0.001 0.999  0       0      1     4     1978   2008
#   1     2     2   0    0.5   0.001 0.999  0       0      1     4     1978   2008
#   1     3     3   0    0.99  0.001 0.999  0       0      1    -4     1978   2008
#   1     4     1   0    0.5   0.001 0.999  0       0      1     4     2009   2015
#   1     5     2   0    0.5   0.001 0.999  0       0      1     4     2009   2015
#   1     6     3   0    0.99  0.001 0.999  0       0      1    -4     2009   2015
# Gear-2
...
# Gear-4
   4     8     1   0    0.655565 0.001 0.999  0       0      1    -4     1978   2015
   4     9     2   0    0.912882 0.001 0.999  0       0      1    -4     1978   2015
   4     10    3   0    0.999 0.001 0.999  0       0      1    -4     1978   2015
# Gear-5
   5     11    1   0    0.347014 0.001 0.999  0       0      1    -4     1978   2015
   5     12    2   0    0.720493 0.001 0.999  0       0      1    -4     1978   2015
   5     13    3   0    0.999 0.001 0.999  0       0      1    -4     1978   2015
## Retained
# Gear-1
...
## ival    lb       ub    phz   prior   p1       p2    Analytic?   LAMBDA
   1.0     0.0001   2.0   -4    0       0.0001   2.0   0           1       # NMFS trawl
#   0.003   0.0001   1.0    4    0       0.0001   2.0   0           1       # ADF&G pot
   3.98689 0.0001   4.0    4    0       0.0001   4.0   0           1       # ADF&G
## ———————————————————————————————————————————————————————————————————————————————————— ##
